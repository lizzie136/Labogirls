...
/* harmony import */ var _js_qrgenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/qrgenerator */ "./src/js/qrgenerator.js");
/* harmony import */ var _js_login__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/login */ "./src/js/login.js");


Object(_js_login__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
var baseCanvas = document.getElementById('generated-qr');
var str = Object(_js_qrgenerator__WEBPACK_IMPORTED_MODULE_0__["generatePaymentString"])({
  motive: 'ejemplo',
  amount: 125.99,
...
baseCanvas && Object(_js_qrgenerator__WEBPACK_IMPORTED_MODULE_0__["generateQR"])(str, baseCanvas, function (err) {
...
/*!*******************************!*\
  !*** ./src/js/qrgenerator.js ***!
  \*******************************/
/*! exports provided: generateQR, generatePaymentString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateQR", function() { return generateQR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generatePaymentString", function() { return generatePaymentString; });
...
var generatePaymentString = function generatePaymentString(_ref) {
  var motive = _ref.motive,
      amount = _ref.amount,
      date = _ref.date,
  ...
  var baseUrl = "".concat(BBVABANCOMER_SIMULATOR, "/venta?");
  var params = [];
...
var generateQR = function generateQR(text, element) {
  return new Promise(function (resolve, reject) {
    qrcode__WEBPACK_IMPORTED_MODULE_0___default.a.toDataURL(element, text).then(function (url) {
      resolve && resolve(url);
    }).catch(function (err) {
      reject && reject(err);
    });
